...
public class Main4 {
	public static void main(String[] args) {
		...
		friday = friday.replaceAll("금요일", "쾋");
		StringTokenizer st = new StringTokenizer(friday,"쾋");
		System.out.println(st.countTokens() - 1);
		
		String[] arr2 = friday.split("시계");
		System.out.println(arr2.length - 1);
		friday = friday.replaceAll("시계", "홒");
		StringTokenizer st2 = new StringTokenizer(friday,"홒");
		System.out.println(st2.countTokens() - 1);
